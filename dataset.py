...
class VideoDataset(Dataset):
    ...
    def __init__(self, dataset='ucf101', split='train', clip_len=16, preprocess=False):
        self.root_dir, self.output_dir = Path.db_dir(dataset)   #root_dir是：  output_dir是：
    ...
    def process_video(self, video, action_name, save_dir):
        ...
        if frame_count < 16:
            print("Video = ", os.path.join(self.root_dir, action_name, video))
...
if __name__ == "__main__":
    ...
    train_data = VideoDataset(dataset='celeb-df', split='train', clip_len=8, preprocess=False)
